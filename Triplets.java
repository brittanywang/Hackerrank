...
If a[i] > b[i], then A gets a point.
If b[i] > a[i], then B gets a point.
If a[i] = b[i], then neither person receives a point.

Output: return an array of two integers denoting the respective comparison points earned by A and B.
